...
def sep_x(raw_data, output_dir):
    ...
    return FOrg.list_to_csv(raw_data, data_x, 1, output_dir)
...
def sep_y(raw_data, output_dir):
    ...
    return FOrg.list_to_csv(raw_data, data_y, 2, output_dir)
...
def sep_z(raw_data, output_dir):
    ...
    return FOrg.list_to_csv(raw_data, data_z, 3, output_dir)
...
def sep_abs(raw_data, output_dir):
    ...
    return FOrg.list_to_csv(raw_data, data_abs, 4, output_dir)


def main():
    star_time = time.time()
    raw_data, output_dir = FOrg.csv_to_list()
    try:
