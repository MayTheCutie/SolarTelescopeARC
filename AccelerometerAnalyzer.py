...
def main():
    ...
    # This initial section will force you to input two sets of data to begin with (but only use the
    # initial data/plot props)
    ...
    for idx, (plot_properties, data) in enumerate(zip(properties_list, data_list)):
        ...
        plot_type, upper_cutoff, lower_cutoff, window_size, max_freq, starter_time_cutoff, end_time_cutoff = extract_plot_properties(
            plot_properties, idx)
